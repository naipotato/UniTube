...
{
    public class VideoListRequest : RequestBase<VideoListReponse>
    {
        private string part;

        internal VideoListRequest(string part) => this.part = part;

        public override Task<VideoListReponse> ExecuteAsync()
        {
